...
figure(3); hold on;
plot(t, current2./parallel_nums(2), 'LineWidth', 1.0, 'DisplayName', 'SiC MOSFET'); 
plot(t, current7./parallel_nums(7), 'LineWidth', 1.0, 'DisplayName', 'Si IGBT');
legend;
disp(max(current7./parallel_nums(7)));
